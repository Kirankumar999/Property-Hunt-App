    ...
    <section className="bg-yellow-400 py-20">
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className="md:ml-4 mt-4 md:mt-0 w-full md:w-auto px-6 py-3 rounded-lg bg-gray-900 text-white hover:bg-gray-600 focus:outline-none focus:ring focus:ring-blue-500"
          >
            Search
          </button>
        </form>
